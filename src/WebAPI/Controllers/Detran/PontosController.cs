...
namespace DesignPatternSamples.WebAPI.Controllers.Detran
{
    ...
    public class PontosController : ControllerBase
    {
        ...
        [HttpGet()]
        [ProducesResponseType(typeof(SuccessResultModel<IEnumerable<PontoCarteira>>), StatusCodes.Status200OK)]
        public async Task<ActionResult> Get([FromQuery]CarteiraModel model)
        {
            ...
            var result = new SuccessResultModel<IEnumerable<PontoCarteira>>(_Mapper.Map<IEnumerable<PontoCarteira>>(Pontos));
